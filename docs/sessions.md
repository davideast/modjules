...
A **Source** defines the *context* in which the agent operates. Currently, the primary source type is a **GitHub Repository**. When you start a session, you are telling the agent: *"Do this task, inside this repository, starting from this branch."*
